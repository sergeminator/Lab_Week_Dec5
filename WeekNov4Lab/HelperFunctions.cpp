...
void DisplayIntroMessage(HANDLE hConsole)
{
	...
	SetConsoleTextAttribute(hConsole, FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_BLUE);
...
void DisplayTuesdayLabUserList(HANDLE hConsole)
{
	...
	std::cout << "                 Sydney ikegwuonu          SydneyisMe                   " << std::endl;
...
void DisplayWednesdayLabUserList(HANDLE hConsole)
{
	...
	std::cout << "                 Beomjin Kim              BJin2                   " << std::endl;
	...
	std::cout << "                 Carlos Allison           cccxrelesss                   " << std::endl;
